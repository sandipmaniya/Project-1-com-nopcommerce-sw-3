...
//      1.4 Verify the Product will arrange in Descending order.
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Akshay");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Kumar");
        sendTextToElement(By.id("BillingNewAddress_Email"), "Akshay@gmail90.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "Aksh1234");
        ...
        sendTextToElement(By.id("BillingNewAddress_City"), "Jalsa");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "8900 154th Street");
        sendTextToElement(By.id("BillingNewAddress_Address2"), "jalsa,empire");
